        ...
        <Std_Master img={bild_1} inner={
            <div className="">
                ...
                <div className="md:flex sm:flex flex-wrap z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                    <Product_card img={download} price="100Kr" title="Kassa 1" ribbon="16800 Kr" description="molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium"/>
                    ...
                    <Product_card img={download} price="100Kr" title="Kassa 3" ribbon="16800 Kr" description="molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium"/>
                    ...
                    <Product_card img={download} price="100Kr" title="Kassa 5" ribbon="16800 Kr" description="molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium"/>
                    ...
                    <Product_card img={download} price="100Kr" title="Kassa 7" ribbon="16800 Kr" description="molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium"/>
                    ...
                    <Product_card img={download} price="100Kr" title="Kassa 9" ribbon="16800 Kr" description="molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium"/>
                </div>
            </div>
        } />
    )
